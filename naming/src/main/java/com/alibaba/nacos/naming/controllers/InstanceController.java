...
public class InstanceController {
    ...
    public String register(HttpServletRequest request) throws Exception {
        ...
        final String namespaceId = WebUtils
                .optional(request, CommonParams.NAMESPACE_ID, Constants.DEFAULT_NAMESPACE_ID); //获取namespaceId
        final String serviceName = WebUtils.required(request, CommonParams.SERVICE_NAME); //获取必须的serviceName
